...
const LEVEL_SPAWNS = [
	...
	[
		...
		Vector2(320, 320), Vector2(2752, 320), Vector2(5312, 320), Vector2(704, 448),
		Vector2(2880, 448), Vector2(5056, 448), Vector2(7232, 448), Vector2(2752, 576),
		Vector2(5312, 576), Vector2(448, 832), Vector2(2368, 960), Vector2(4544, 960),
		Vector2(6720, 960), Vector2(1856, 1088), Vector2(4032, 1088), Vector2(6208, 1088),
		Vector2(1472, 1216), Vector2(4032, 1216), Vector2(6592, 1216), Vector2(1344, 1600),
		Vector2(3520, 1600), Vector2(5696, 1600), Vector2(704, 1728), Vector2(2880, 1728),
		Vector2(5056, 1728), Vector2(7232, 1728), Vector2(2496, 1856), Vector2(5184, 1856),
		Vector2(320, 2112), Vector2(2240, 2240), Vector2(4416, 2240), Vector2(6592, 2240),
		Vector2(1984, 2368), Vector2(4544, 2368), Vector2(7104, 2368), Vector2(2240, 2496),
		Vector2(4416, 2496), Vector2(6592, 2496), Vector2(1344, 2880), Vector2(3904, 2880),
		Vector2(6464, 2880), Vector2(1728, 3008), Vector2(3904, 3008), Vector2(6080, 3008),
		Vector2(1088, 3136), Vector2(3264, 3136), Vector2(5440, 3136), Vector2(448, 3264),
		Vector2(2496, 3520), Vector2(5184, 3520), Vector2(576, 3648), Vector2(2624, 3648),
		Vector2(4800, 3648), Vector2(6976, 3648), Vector2(1984, 3776), Vector2(4160, 3776),
		Vector2(6336, 3776), Vector2(1216, 4160), Vector2(3776, 4160), Vector2(6336, 4160),
		Vector2(1472, 4288), Vector2(3648, 4288), Vector2(5824, 4288), Vector2(832, 4416),
		Vector2(3520, 4416), Vector2(6080, 4416), Vector2(960, 4800), Vector2(3136, 4800),
		Vector2(5312, 4800), Vector2(320, 4928), Vector2(2496, 4928), Vector2(4672, 4928),
		Vector2(6848, 4928), Vector2(2240, 5056), Vector2(4800, 5056),
